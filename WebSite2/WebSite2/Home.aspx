...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mainLabel">
            ...
            <asp:Label ID="Label1" runat="server" Text="THIS IS THE MAIN TITLE"></asp:Label>
        ...
        <div class="subLabel">
            ...
            <asp:Label ID="Label4" runat="server" Text="This is the subtitle"></asp:Label>
        ...
        <div class="buttons">
            ...
            <asp:Button ID="BTN_118" runat="server" Text="BUTTON NUMBER1" OnClick="BTN_118_Click" />
            <br />
            <br />
            <asp:Button ID="BTN_115" runat="server" Text="BUTTON NUMBER2" OnClick="BTN_115_Click" Style="top: 74%" />
            <br />
            <br />
